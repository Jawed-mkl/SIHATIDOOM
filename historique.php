...
$sql1 = "SELECT * FROM rendez_vous WHERE patients_id = '$id' ";
...
<body>
    ...
    <div class="header">
        ...
        <!-- Start content Table -->
        <div class="content p-20 bg-white rad-10 m-20">
            <h2 class="mt-0 mb-20">Historique :</h2>
            <div class="table">
                ...
                <?php
                    if ($result1->num_rows > 0) {
                        while ($row = $result1->fetch_assoc()) {
                            echo "<tr>";
                            echo "<td>" . htmlspecialchars($patient_info['username']) . "</td>";
                            echo "<td>" . htmlspecialchars($patient_info['phone']) . "</td>";
                            echo "<td>" . htmlspecialchars($row['address']) . "</td>";
                            echo "<td>" . htmlspecialchars($row['date_rendez_vous']) . "</td>";
                            echo "<td>" . htmlspecialchars($row['heure_rendez_vous']) . "</td>";
                            echo "<td>" . htmlspecialchars($row['acte_paramedical']) . "</td>";
