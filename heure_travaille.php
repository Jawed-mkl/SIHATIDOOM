...
<div class="container">
    ...
    <div class="table-wrapper">
        ...
        if ($total_members == 0) {
            $output = "<tr><td colspan='9'>Aucun membre trouvé</td></tr>";
        } else {
            ...
            // Requête SQL pour récupérer les heures de travail des professionnels
        $sql = "SELECT id, username, usertype, start_time, end_time 
                FROM professionnels 
                ORDER BY id ASC";
