...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Update patient's information in the database
    $update_sql = "UPDATE patients SET username='$username', email='$email', phone='$phone', password='$password', sex='$sex', address='$address' WHERE id='$id'";
...
<body>
    ...
    <div class="header">
        ...
        <div class="container-content">
            <div class="contents">
                <h1 class="form-title">modifier information</h1>
                <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                    <div class="main-user-info">
                    <div class="user-input-box" style="width: 80%;">
                    ...
                    <div class="user-input-box" style="width: 80%;">
                        ...
                        <input type="text"
                                ...
                                value="<?php echo $patient_info['phone']?>"/>
                    </div>
                    <br>
                    <div class="user-input-box" style="width: 80%;">
                        ...
                        <input type="password"
                                ...
                                value="<?php echo $patient_info['password']?>"/>
                    </div>
                    <br>
                    <div class="user-input-box" style="width: 80%;">
                        ...
                        <input type="text"
                                ...
                                name="sex"
                                placeholder="Enter Phone Number"
                                value="<?php echo $patient_info['sex']?>"/>
                    </div>
                    <br>
                    <div class="user-input-box" style="width: 80%;">
