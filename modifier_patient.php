...
// Vérifier si l'identifiant du patient est passé dans l'URL 
if (isset($_GET['id'])) { 
    ...
    if (!empty($id)) { 
        // Préparer la requête SQL pour récupérer les informations du patient 
        ...
        if ($result->num_rows > 0) { 
            ...
            // Les informations du patient sont stockées dans $row 
        } else { 
        ...
        echo "Identifiant du patient invalide."; 
    } 
} else { 
    echo "Identifiant du patient non spécifié."; 
} 
...
<body> 
    <div class="form-wrapper"> 
        ...
        <form action="modifier_patient_script.php" method="post"> 
